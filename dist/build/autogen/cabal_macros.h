...
/* package ProjectFP-0.1.0.0 */
#define VERSION_ProjectFP "0.1.0.0"
#define MIN_VERSION_ProjectFP(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package megaparsec-5.1.2 */
#define VERSION_megaparsec "5.1.2"
